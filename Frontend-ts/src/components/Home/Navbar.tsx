...
import { MdHome, MdOutlineExplore, MdNotifications, MdChat, MdSearch } from "react-icons/md"
  ...
  return (
    <nav className="w-full flex items-center p-2 px-4 border bg-white sticky top-0">
      ...
      <div className="w-2/12 px-3">
        <button className="w-full rounded bg-teal-500 px-4 py-2 text-white hover:bg-teal-600 focus:outline-none">Login</button>
      </div>
    </nav>
  )
}

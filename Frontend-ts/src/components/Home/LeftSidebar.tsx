        ...
        <div className="w-full py-2">
          ...
          <div className="w-full mt-3">
            {dummyData.people.map((person) => (
              <div className="w-full flex items-center justify-between my-4" key={person.id}>
                <Link to={`/${person.username}`} className="w-fit flex items-center gap-2">
                  <img
                ...
                <button className="text-teal-600 font-medium hover:text-teal-500 h-fit p-2 text-sm rounded-md">Follow</button>
              </div>
            ))}
        ...
        <div className="w-full py-2 border-t">
          ...
          <div className="w-full mt-3">
            {dummyData.communities.map((community) => (
              <div className="w-full flex items-center justify-between my-4" key={community.id}>
                <Link to={`/${community.name}`} className="w-fit flex items-center gap-2">
                  <img
                ...
                <button className="text-teal-600 font-medium hover:text-teal-500 h-fit p-2 text-sm rounded-md">Join</button>
              </div>
            ))}
            <div className="w-full">
              <button className="text-blue-500">See All</button>
